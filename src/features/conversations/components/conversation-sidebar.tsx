...
export const ConversationSidebar = ({
  ...
  const [selectedConversationId, setSetselectedConversationId] =
  ...
  const handleCreateConversation = async () => {
    try {
      ...
      setSetselectedConversationId(newConversationId);
  ...
  return (
    <>
      <PastConversationsDialog
        ...
        onSelect={setSetselectedConversationId}
      />
      <div className="flex flex-col h-full bg-sidebar">
        ...
        <div className="p-3">
          <PromptInput onSubmit={handleSubmit} className="mt-2">
            <PromptInputBody>
              <PromptInputTextarea
                placeholder="Ask Altair everything..."
